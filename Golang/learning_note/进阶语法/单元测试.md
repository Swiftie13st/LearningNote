...
![](https://raw.githubusercontent.com/Swiftie13st/Figurebed/main/img/202207071537690.png)
...
3. 示例函数提供了可以直接运行的示例代码，可以直接在`golang.org`的`godoc`文档服务器上使用`Go Playground`运行示例代码。下图为`strings.ToUpper`函数在Playground的示例函数效果。![](https://raw.githubusercontent.com/Swiftie13st/Figurebed/main/img/202207071551041.png)
